            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="mr-1">Hello,
                  <span class="user-name text-bold-700">USER</span>
                </span>
    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title mb-0">Results</h3>

        </div>
        <div class="content-header-right text-md-right col-md-6 col-12">
          <a href="/review">
            <button type="submit" class="success">Submit A Review</button>
          </a>
        </div>  
      </div>
                          ...
                          <div class="col-lg-4 col-md-12">
                            <div class="card">
                              <div class="card-content">
                                <div class="card-body">
                                  <h4 class="card-title info">Name : {{$d->name}}</h4>
                                  <p class="card-text"> Description : {{$d->description}}</p>
                                  <p class="card-text">Cost : {{$d->cost}}</p>
                                  <p class="card-text">Hospital where available : {{$d->gethospital->name}}</p>
                                </div>
                              </div>
                            </div>
                          </div>
