              ...
              <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                ...
                <div class="card-content">
                  <p class="card-subtitle line-on-side text-muted text-center font-small-3 mx-2 my-1">
                    <span>Search For Reports</span>
                  </p>
                  <div class="card-body">
                    {!! Form::open(['action'=>['App\Http\Controllers\SearchController@store'],'method'=>'POST','enctype'=>'multipart/form-data']) !!}
                    <fieldset class="form-group position-relative has-icon-left">
                        <input name="search" type="text" class="form-control" id="user-name" placeholder="Search Criteria"
                        required>
                      ...
                      {{Form::submit('Search' ,['class'=>'btn btn-outline-info btn-block','id'=>"helpInputTop"])}}
                  ...
                  <div class="card-body">
                    <a href="{{url('hosp')}}/create" class="btn btn-outline-danger btn-block"><i class="la la-book"></i> View All Available Hospitals</a>
                  </div>
                </div>
              </div>
            </div>
