    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title mb-0">ADD HOSPITAL</h3>
      ...
      <div class="content-body">
        ...
        {!! Form::open(['action'=>['App\Http\Controllers\hospitalController@store'],'method'=>'POST','enctype'=>'multipart/form-data']) !!}
                  ...
                  <div class="card-body card-dashboard">
                    <div class="card-body">
                        <fieldset class="form-group">
                          <input name="name" type="text" class="form-control" id="basicInput" placeholder="Hospital Name">
                        </fieldset>
                      </div>
                      <div class="card-body">
                        <fieldset class="form-group">
                          <input name="location" type="text" class="form-control" id="basicInput" placeholder="Hospital Location">
                        </fieldset>
                      </div>
                      <div class="card-body">
                        <fieldset class="form-group">
                          <input name="phone" type="text" class="form-control" id="basicInput" placeholder="Hospital Phone Number">
                        </fieldset>
                      </div>
                      <div class="card-body">
                        <fieldset class="form-group">
